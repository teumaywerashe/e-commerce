  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-950">
      ...
      <div className="border-b border-neutral-100 dark:border-gray-800 py-10 px-6 text-center">
        ...
        <h1 className="text-2xl font-light tracking-widest uppercase text-primary dark:text-white">{title}</h1>
        {!loading && (
      ...
      <div className="max-w-screen-xl mx-auto px-6 py-10 flex gap-10">
        ...
        {isSidebarOpen && (
          <div className="fixed inset-0 z-50 flex">
            ...
            <div ref={sidebarRef} className="relative w-72 bg-white dark:bg-gray-900 h-full overflow-y-auto z-10">
              <div className="flex items-center justify-between px-6 h-14 border-b border-neutral-100 dark:border-gray-800">
                <span className="text-[10px] font-semibold tracking-widest uppercase text-gray-900 dark:text-white">Filter</span>
                <button onClick={() => setIsSidebarOpen(false)} className="cursor-pointer text-neutral-400 hover:text-primary dark:hover:text-white">
