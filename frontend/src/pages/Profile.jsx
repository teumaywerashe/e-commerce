      ...
      <div className="max-w-screen-xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row gap-10">
          ...
          <div className="md:w-56 shrink-0">
            <div className="border border-neutral-100 dark:border-gray-800 p-6 dark:bg-gray-900">
              <div className="w-12 h-12 bg-primary dark:bg-white flex items-center justify-center mb-4">
                <span className="text-white dark:text-gray-900 text-sm font-semibold tracking-widest uppercase">
                  {user?.name?.charAt(0)}
                </span>
              </div>
