...
function ProductDetails({ error, loading, productId }) {
  ...
  if (loading)
    return (
      <div className="max-w-7xl mx-auto px-6 py-16 animate-pulse flex flex-col md:flex-row gap-12">
  ...
  if (error)
    return (
      <p className="text-center text-neutral-400 py-16 text-xs tracking-widest uppercase">
        {error}
      </p>
    );
    ...
    <div className="max-w-7xl mx-auto px-6 py-16">
      <div className="flex flex-col md:flex-row gap-12">
        ...
        <div className="flex-1 flex flex-col">
          <p className="text-[10px] font-medium tracking-widest3 uppercase text-neutral-400 mb-2">
            {selectedProduct.brand}
          </p>
          <h1 className="text-2xl font-light tracking-wide text-primary dark:text-white mb-4 leading-snug">
          ...
          <div className="mb-8">
            ...
            <div className="flex items-center gap-4">
              <button
                ...
                className="w-8 h-8 border border-neutral-300 dark:border-gray-600 bg-white dark:bg-gray-900 text-primary dark:text-white flex items-center justify-center text-sm hover:bg-primary dark:hover:bg-white hover:text-white dark:hover:text-gray-900 hover:border-primary disabled:opacity-30 transition-colors cursor-pointer"
              >
                −
              </button>
              <span className="text-sm font-medium text-primary dark:text-white w-6 text-center">
                {quantity}
              </span>
              <button
                onClick={() => setQuantity((p) => p + 1)}
                className="w-8 h-8 border border-neutral-300 dark:border-gray-600 bg-white dark:bg-gray-900 text-primary dark:text-white flex items-center justify-center text-sm hover:bg-primary dark:hover:bg-white hover:text-white dark:hover:text-gray-900 hover:border-primary transition-colors cursor-pointer"
              >
                +
              </button>
            </div>
          ...
          <button
            ...
            className={`w-full py-4 text-[11px] font-semibold tracking-widest2 uppercase transition-colors cursor-pointer ${
              disabled
                ? "bg-neutral-200 dark:bg-gray-700 text-neutral-400 cursor-not-allowed"
                : "bg-primary dark:bg-white text-white dark:text-gray-900 hover:bg-neutral-800 dark:hover:bg-neutral-200"
            }`}
          >
          ...
          <div className="mt-10 pt-8 border-t border-neutral-100 dark:border-gray-800 grid grid-cols-2 gap-4">
            {[
              ...
              <div key={l}>
                <p className="text-[9px] font-semibold tracking-widest uppercase text-neutral-400 mb-0.5">
                  {l}
                </p>
      ...
      {similarProducts?.length > 0 && (
        <div className="mt-24">
          <p className="text-[10px] font-medium tracking-widest3 uppercase text-neutral-400 text-center mb-2">
            You May Also Like
          </p>
          <h2 className="text-xl font-light tracking-widest uppercase text-center text-primary dark:text-white mb-10">
            Similar Pieces
          </h2>
