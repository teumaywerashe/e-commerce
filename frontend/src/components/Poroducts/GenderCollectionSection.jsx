...
const collections = [
  {
    ...
    img: menscollectioImage,
    alt: "Men's Collection",
  },
  {
    label: "Women",
    to: "/collections/all?gender=Women",
    img: womenscollectioImage,
  ...
  return (
    <section className="py-20 px-6 bg-white dark:bg-gray-950">
      <div className="max-w-7xl mx-auto">
        ...
        <h2 className="text-xl font-light tracking-widest uppercase text-center text-primary dark:text-white mb-12">
          Shop by Gender
        </h2>
          ...
          {collections.map((c) => (
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 p-8 flex items-end justify-between">
                <div>
                  <p className="text-[10px] font-medium tracking-widest3 uppercase text-white/60 mb-1">
                    {c.label}
                  </p>
                  <h3 className="text-2xl font-light tracking-widest uppercase text-white">
                    {c.label}'s Collection
                  </h3>
                </div>
